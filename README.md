...
- **灵活的自动化接口**: 支持在每个文件下载成功后自动执行自定义回调脚本，轻松集成到自动化工作流中。
- **AI 原生适配**: 代码层面深度集成 `toolcall` 模式以获取结构化输出，并适配长耗时下载任务。
...
<div align="center">
  <a href="https://clawhub.ai/chrisis58/skills/kmdr">
    <img src="https://img.shields.io/badge/Get%20from-ClawHub-orange?style=for-the-badge&logo=claudecode" alt="Get from ClawHub">
  </a>
</div>

> [!NOTE]
> SKILL 功能目前处于 alpha 阶段，正在持续完善中。欢迎通过 [GitHub Issues](https://github.com/chrisis58/kmdr/issues) 提交使用反馈和改进建议。
